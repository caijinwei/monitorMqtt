...
{
	private static final Logger logger = LogManager.getLogger(RestfulContextListener.class);
	...
	public RestfulContextListener()
	{
		super();
	}

	public RestfulContextListener(WebApplicationContext context)
	{
		super(context);
	}
	...
	{
		logger.info("restful context init ...");
